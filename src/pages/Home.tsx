...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ✅ Make hero section scrollable instead of fixed */}
      <section id="hero" className="relative w-full h-screen overflow-hidden">
        ...
        <main className="relative h-full w-full text-white px-6 md:px-16 flex items-center justify-between">
          ...
          >
            ...
            >
              Fullstack AI Engineer Intern at DeepinsightsX.
              <br />
              Exploring the intersection of design, code, and the world of AI.
            </motion.p>
